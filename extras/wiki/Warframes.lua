return {
	...
	Warframes = {
		...
		Brysko = {
			...
			EnergyRank30 = 0,
			-- ExilusPolarity = "Naramon",
			FullImages = { { TabName = "Profile", Image = "Brysko.png" } },
			Health = 0,
		...
		Narin = {
			...
			EnergyRank30 = 0,
			-- ExilusPolarity = "Naramon",
			FullImages = { { TabName = "Profile", Image = "Narin.png" } },
			Health = 0,
		...
		Orion = {
			...
			Energy = 200,
			FullImages = { { TabName = "Profile", Image = "S&O-Orion.png" } },
			Health = 350,
			...
			Playstyle = { "Damage" },
			Polarities = { "Vazarin", "Madurai", "Aura" },
		...
		Sirius = {
			...
			Description = "Wield the power of the stars in a constant battle for supremacy. The dueling sons, Sirius & Orion, occupy the space of a single Warframe, jockeying for position to rain cosmic destruction upon foes.",
			Energy = 200,
			FullImages = { { TabName = "Profile", Image = "S&O-Sirius.png" } },
			Health = 475,
		...
		["Sirius & Orion"] = { -- NOTE: Use "Sirius" and "Orion" individually to populate page data instead.
		    ...
		    Description = "Wield the power of the stars in a constant battle for supremacy. The dueling sons, Sirius & Orion, occupy the space of a single Warframe, jockeying for position to rain cosmic destruction upon foes.",
		    Energy = 200,
		    FullImages = { { TabName = "Profile", Image = "SiriusOrion.png" } },
		    Health = 475,
		    ...
		    Polarities = { "Vazarin", "Madurai", "Aura", "Vazarin", "Madurai", "Aura" },
		...
		["Styanax Prime"] = {
			...
			Energy = 215,
			FullImages = {
				{ TabName = "Profile", Image = "StyanaxPrime.png" }	},
			Health = 270,
